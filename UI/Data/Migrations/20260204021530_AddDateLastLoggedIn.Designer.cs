...
namespace mass.Data.Migrations
{
    ...
    [Migration("20260204021530_AddDateLastLoggedIn")]
    partial class AddDateLastLoggedIn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mass.Data.MassIdentityUser", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("DateLastLoggedIn")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("date_last_logged_in");
            ...
            modelBuilder.Entity("mass.Data.WritingPrompt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
