...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20251216214027_AddIsArchived') THEN
    ALTER TABLE stories ADD is_archived boolean NOT NULL DEFAULT FALSE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20251216214027_AddIsArchived') THEN
    INSERT INTO "__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20251216214027_AddIsArchived', '10.0.1');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20251218232633_AddWritingPrompts') THEN
    CREATE TABLE writing_prompts (
        id integer GENERATED BY DEFAULT AS IDENTITY,
        prompt_text text NOT NULL,
        CONSTRAINT pk_writing_prompts PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20251218232633_AddWritingPrompts') THEN
    INSERT INTO "__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20251218232633_AddWritingPrompts', '10.0.1');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20260204021530_AddDateLastLoggedIn') THEN
    ALTER TABLE "AspNetUsers" ADD date_last_logged_in timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20260204021530_AddDateLastLoggedIn') THEN
    INSERT INTO "__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20260204021530_AddDateLastLoggedIn', '10.0.1');
    END IF;
END $EF$;
COMMIT;
